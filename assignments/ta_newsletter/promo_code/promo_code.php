...
$index = 1;
echo "REPORT :<table border='1'><tr><th>Path</th><th>Status</th></tr>";
while(! feof($file)) {
	...
	if ($curDate != '1970-01-01') {
		...
		//	echo "<br>Failed to create folder <strong>".$subfolder_path."</strong> or Folder already exits!";
			echo "<tr><td>".$subfolder_path."</td><td style='color:red;'>failed</td></tr>";
		} else {
		...
		//	echo "<br><strong>".$index.") Created files = </strong>".$promoFile_path."<br>";
			echo "<tr><td>".$base_file_path."/".$curDate."</td><td style='color:green;'>success</td></tr>";
