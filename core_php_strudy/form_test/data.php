...
/*Define varaibles*/
	...
	function calculateBMIResult($BMI) {
		if ($BMI <= 18.5) { 
			$BMIResult = "Underweight. Need to gain weight<br><a href=\"http://www.wikihow.com/Gain-Weight\">Gain Weight</a><br>Start adding 500 calories in your daily diet. Thus 3500 per week and you can increase 2Kg.";
		} elseif ($BMI > 18.5 && $BMI <= 24.9) {
			$BMIResult = "of Normal weight. You are free to roam chest out.";	
		} else if($BMI > 24.9 && $BMI <= 29.9) {
			$BMIResult = "Overweight. Should lose some weight<br><a href=\"http://www.wikihow.com/Lose-Weight\">Lose Weight</a><br>";	
		} elseif($BMI > 29.9) {
			$BMIResult = "Obesive. <br>Should care for your weight. Need to lose a lot of weight or simply hide yourself.<br><a href=\"http://www.wikihow.com/Lose-Weight\">Lose Weight</a><br>";	
		} 
		Return $BMIResult;
	}
?>