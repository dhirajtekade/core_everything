<html>
	...
	<link rel="stylesheet" media="all" type="text/css" href="style/bmr.css">		 
			...
			<TABLE  CLASS="table" ALIGN="center" CELLSPACING="1" CELLPADDING="1" BGCOLOR="#FFFFFF" BORDER=0>
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">	
					...
					<TR>
						...
						<TD>
							<SELECT NAME="worktype" SIZE="1" TABINDEX="7">
							  ...
							  <div tooltip="Sedentary: no exercises. Lightly Active: exercises in 2-3 days in week. Moderately Active: exercises in 3-6 days in week. Very Active: sportsperson" >info</div> 
						</TD>
					</TR>
					...
					<TR>
						...
						<TD>
							<INPUT TYPE="radio" NAME="foodPreference" VALUE="vegetarian"  TABINDEX="3" <?php if($_POST['foodPreference']=='vegetarian') echo 'CHECKED=TRUE'; ?>><img src="images/veg.svg" height="25px" width="25px" alt="Vegetarian" title="Vegetarian">
					...
					<TR>
						...
						<TD>
							<INPUT TYPE="radio" NAME="gender" VALUE="Male"  TABINDEX="3" <?php if($_POST['gender']=='Male') echo 'CHECKED=TRUE'; ?>><img src="images/male-sign.jpg" height="25px" width="25px" alt="Male" title="Male">
							<INPUT TYPE="radio" NAME="gender" VALUE="Female" TABINDEX="4"  <?php if($_POST['gender']=='Female') echo 'CHECKED=TRUE'; ?>><img src="images/female-sign.jpg" height="25px" width="25px" tooltip="female" alt="Female" title="Female"><br />
						</TD>
					</TR>
					<TR><TD COLSPAN=2>
